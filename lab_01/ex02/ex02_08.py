def chia_het_cho_so_5(so_nhi_phan):
...
so_chia_het_cho_5 = [so for so in so_nhi_phan_list if chia_het_cho_so_5(so)]
if len (so_chia_het_cho_5) > 0:
    ket_qua = ",".join(so_chia_het_cho_5)
    print("Cac so nhi phan chia het cho 5: ", ket_qua)
else:
    print("Khong co so nhi phan nao chia het cho 5 chuoi da nhap.")
